...
if [ "$PROC32" = "y" ]; then
	...
	wget https://github.com/coelho4g/nanored-dublack0001/blob/master/nanotheme.txt &> /dev/null ;
...
wget https://github.com/coelho4g/nanored-dublack0001/blob/master/.nanored.zsh-theme &> /dev/null
sed -e "s/\Remo773/$PROC/g" .remo773.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
